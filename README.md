...
3. Navigate to maincourse_java_jfse_mc05_k8s_EKS_springboot_angular_exercise_solution folder

    `cd maincourse_java_jfse_mc05_k8s_EKS_springboot_angular_exercise_solution`
